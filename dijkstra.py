...
def dijkstra(maze, start_node, exit_node):
    '''
    ...
    # Add start node to the g matrix
    ...
    while (True):
        ...
        maze[yc][xc] = '2'
        # remove the current node from g list
        g[yc][xc] = 9999999

        # Visit all of the neighbors around the current node and update the
        # entries in the map, g and parent arrays
        ...
        for nums in range(4):
            ...
            if maze[ad_node[0]][ad_node[1]] == '0' or maze[ad_node[0]][ad_node[1]] == '7' or maze[ad_node[0]][
                ad_node[1]] == '4':
                if g[ad_node[0]][ad_node[1]] > min_g + 1:
                    g[ad_node[0]][ad_node[1]] = min_g + 1
...
def main():
    ...
    # run the  algorithm
    # t1 = t.time()
    dijkstra(maze, entrance_node, exit_node)
    # t2 = t.time()
